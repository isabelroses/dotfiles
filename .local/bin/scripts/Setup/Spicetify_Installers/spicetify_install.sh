...
# Modified by joan31 2022/12/17 - Commented functions to create PATH in shell config
# Added command to create symlink of spicetify binary in local user bin path
...
echo "Create symlink for binary"
ln -sf "$exe" ""$HOME"/.local/bin/spicetify"
