...
On macOS with nix installed you may notice that your CPU is absolutely being
pegged. This is almost certainly because of gatekeeper. You can disable
gatekeeper by opening settings > Privacy & Security > "Allow applications from"
and setting that to "Anywhere". This is caused by most nix store items not
being signed.
