...
if utils.is_linux() or utils.is_darwin() then
  c.default_prog = { "/etc/profiles/per-user/comfy/bin/fish", "--login" }
elseif utils.is_windows() then
...
-- local function recompute_size(window)
...
-- 	end
--
-- 	local pwidth = window_dims.pixel_width
-- 	local pheight = window_dims.pixel_height
-- 	-- window:set_inner_size(pwidth, pheight)
-- end
--
-- wezterm.on("window-resized", function(window, pane)
-- 	recompute_size(window)
-- end)
